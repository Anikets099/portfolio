                    ...
                    <div className='space-y-8'>
                        <div className='flex items-start'>
                            ...
                            <div>
                                ...
                                <p>At post.Lohata(west) Tal.Kallamb Dist.Dharashiv</p>
                            </div>
                        ...
                        <div className='flex items-start'>
                            ...
                            <div>
                                ...
                                <p>aniketjadhav77999@gmail.com</p>
                            </div>
                        ...
                        <div className='pt-4'>
                            ...
                            <div className='flex space-x-4'>
                                ...
                                text-purple hover:bg-black hover:text-white transition duration-300'>
                                    <FaGithub/>
                                </a>
                                ...
                                <a href="#" className='w-12 h-12 rounded-full
                                bg-dark-300 flex items-center justify-center 
                                text-purple hover:bg-blue hover:text-white transition duration-300'>
                                    <FaLinkedin/>
                                </a>
